...
export default function Portais() {
  ...
  // Funções auxiliares para Portal da Coragem
  ...
  if (currentScreen === 'portal' && selectedPortal) {
    ...
    // Se for Portal da Coragem, usar lógica específica
    if (selectedPortal.id === 'coragem') {
      return (
    ...
    // Para outros portais, usar lógica padrão
    return (
  ...
  // Lógica do Portal da Coragem (steps) - apenas se estivermos no portal da coragem
  if (currentScreen === 'portal' && selectedPortal && selectedPortal.id === 'coragem') {
    if (step === 'reflection') {
      return (
        <div className={getBackgroundClass()}>
          <div className="flex items-center justify-center p-6 min-h-screen">
